...
public class ImageDriver {
    public static void main(String[] args) {
        ...
        System.out.println("");
        //My own testing
        //Flip horizontal feature with 2*2 array
        theSelfie = new int [][]{ {8, 20},
                                  {32, 44} };
        selfie = new Image(theSelfie);
        originalImage = selfie.toString();
        // Use the flip horizontal operation method
        ...
        //Flip vertical feature using an array with height greater than width
        theSelfie = new int [][]{ {17, 5},
                                  {2, 20},
                                  {33, 40},
                                  {24, 36}   };
        ...
        System.out.println("Image After Operation : " + imageAfterOperation);
        System.out.println("");
        //Rotate clockwise feature with width greater than height
        theSelfie = new int [][]{ {17, 2, 5, 40},
                                  {13, 20, 31, 32} };
        originalImage = selfie.toString();
        ...
        //Rotate anticlockwise feature with a 2*2 array
        theSelfie = new int [][]{ {8, 20},
                                  {32, 44} };
        selfie = new Image(theSelfie);
        originalImage = selfie.toString();
